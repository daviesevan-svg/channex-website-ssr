...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      description: "WhiteLabel plan from $130/month plus $7 per hotel or $0.50 per vacation rental unit. No commission, no setup costs, and every chargeable extra published on the pricing page.",
